...
<script>
    ...
    $("#dep").show();
      ...
      function updateinfo(itag)
   {
    $('#form1').attr('action', 'updateinfo');
    $(".modal-title").text("Мэдээ засварлах");
    $("#executor").hide();
    $("#dep").hide();
    $('.delete').show();
       $.get('infofill/'+itag,function(data){
           $.each(data,function(i,qwe){
             
               $('#info_id').val(qwe.info_id);
               $('#self_room').val(qwe.self_room);
               $('#self_plot').val(qwe.self_plot);
               $('#ex_room').val(qwe.ex_room);
               $('#ex_plot').val(qwe.ex_plot);
               $('#ex_train').val(qwe.ex_train);
               $('#ex_container').val(qwe.ex_container);
               $('#loc_z').val(qwe.loc_z);
               $('#loc_a').val(qwe.loc_a);
               $('#loc_s').val(qwe.loc_s);
               $('#pas_vag').val(qwe.pas_vag);
               $('#pas_teesh').val(qwe.pas_teesh);
               $('#company_car').val(qwe.company_car);
